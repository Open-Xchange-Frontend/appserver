...
module.exports = function (options) {
  ...
  return function proxyLogin (request, response, next) {
    ...
    const isGetRampup = remoteURL.pathname === loginPath && request.method === 'GET' && remoteURL.searchParams.get('rampup') === 'true'
    const isPostLogin = remoteURL.pathname === loginPath && request.method === 'POST'
